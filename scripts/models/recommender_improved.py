...
EPOCHS = 100
LEARNING_RATE = 5e-4
EMBEDDINGS_REGULARIZER = tf.keras.regularizers.L2(l2=1e-3)
...
MLP_LAYER_2 = 64
MLP_DROPOUT = 0.3
DENSE_REGULARIZER = tf.keras.regularizers.L2(l2=1e-3)
...
class CustomerModel(tf.keras.Model):
    def __init__(self, article_lookup, article_embedding):
        ...
        self.age_normalization = tf.keras.layers.BatchNormalization()
    ...
    def call(self, features, training=False):
        ...
        age_scaled = self.age_normalization(age_scaled, training=training)
